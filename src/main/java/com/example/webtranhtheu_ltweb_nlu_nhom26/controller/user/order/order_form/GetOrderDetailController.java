...
@WebServlet(name = "GetOrderDetailController", value = "/user/get-order-detail")
public class GetOrderDetailController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/layout/user/orders/order-form/read-detail-order.jsp").forward(request, response);
    }
