...
<div id="user-info" class="content-details col">
  ...
  <div class="input-info container">
    <div class="user-inputs">
      <div class="row">
        <div class="col p-3">Tên:</div>
        <div class="col p-3">Họ:</div>
      </div>
      <div class="row">
        <div class="col"><input id="fname" type="text" placeholder="Tên" value="${account.fullName}"></div>
        <div class="col"><input id="lname" type="text" placeholder="Họ" value="${account.fullName}"></div>
      </div>
      <div class="row">
        <div class="col-12 p-3">Địa chỉ email:</div>
        <div class="col-8"><input type="email" placeholder="Email" style="width: 100%" value="${account.email}"></div>
      </div>
    </div>
    <!-- Thay đổi mật khẩu -->
