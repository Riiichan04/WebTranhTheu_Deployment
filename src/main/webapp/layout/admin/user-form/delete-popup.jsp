...
<div id="formContainer">
    ...
    <form id="confirmModal">
        <div class="modal-content py-4">
            <h5 class="style-title"><i class="fa-solid fa-circle-question me-2"></i>Xóa người dùng</h5>
            <hr>
            <h6 class="style-text">Bạn chắc chắn muốn xóa <span class="style-name-element">Tên đăng nhập</span>?</h6>
            <hr>
            <div class="text-end">
