<%--Demp tạm apply attribute từ controller vào--%>
...
<nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb" class="container">
    <ol class="breadcrumb pt-2">
        ...
        <li class="breadcrumb-item" aria-current="page"><a href="/category/tranh-theu-tay">${category}</a></li>
        <li class="breadcrumb-item" aria-current="page"><a href="/category/tranh-theu-tay/tranh-phong-canh">${category} ${topic}</a></li>
    ...
    <div class="background-container rounded">
        <div class="row">
            <div class="col-3 p-4_5">
                ...
                <div class="w-100">
                    <c:forEach var="size" items="${product.listPrice}">
            ...
            <div class="col ps-4_5 p-4_5 ">
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-6">Danh mục: <span class="fw-semibold">${product.category}</span></div>
                </div>
                <div class="row mt-2">
                    <div class="col-6">Nguyên liệu: <span class="fw-semibold">
                        <c:forEach var="material" items="${product.listMaterial}">
                            ${material.name}
                        </c:forEach>
                    </span></div>
                    <div class="col-6">Chủ đề: <span class="fw-semibold">${product.topic}</span></div>
                </div>
                <div class="row mt-2">
                    <div class="col-6">Hãng sản xuất: <span class="fw-semibold">${product.provider.prodiverName}</span></div>
                    <div class="col-6">Còn lại: <span class="fw-semibold">${defaultPrice.available}</span></div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-6 text-center">
                        <h2 style="color: var(--main-cta-button)">${defaultPrice.price} VNĐ</h2>
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col-6">
            ...
            <form class="row mt-4">
                ...
                <div class="col-8">
                    <textarea class="form-control" id="product-review--comment" rows="4"
                              placeholder="Đánh giá của bạn về sản phẩm" id="comment-content"></textarea>
