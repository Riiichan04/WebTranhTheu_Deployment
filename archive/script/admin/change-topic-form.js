function changeFormTopic(btn) {
    ...
    switch (btn) {
        case 'addTopicBtn':
            formWrapper.innerHTML = `<iframe src="topic-form/add-topic-form.html" class="form-popup" id="addIframe"></iframe>`;
        ...
        case 'readAndEditUserBtn':
            formWrapper.innerHTML = `<iframe src="topic-form/read-edit-topic-form.html" class="form-popup" id="readAndEditIframe"></iframe>`;
            ...
            break;
        case 'deleteBtn':
            formWrapper.innerHTML = `<iframe src="topic-form/delete-popup.html" class="form-popup" id="deleteIframe"></iframe>`;
...
$('#myTable').DataTable().on('draw', function () {
    ...
    $('.btn-read-edit').click(function () {
        changeFormTopic('readAndEditUserBtn');
        $('#formWrapper').removeClass('hidden');
